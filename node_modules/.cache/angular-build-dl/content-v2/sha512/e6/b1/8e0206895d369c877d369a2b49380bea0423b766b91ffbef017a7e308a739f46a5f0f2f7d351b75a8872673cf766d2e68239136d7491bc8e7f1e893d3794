(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PostsService = /** @class */ (function () {
                ...
                PostsService.prototype.getAllPosts = function (criteria) {
                    var _this = this;
                    return this.http.get('/routes/posts').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (posts) {
                        _this.arr = posts;
                        _this.arr.forEach(function (item, index) {
                            item['#'] = index + 1;
                        });
                        // console.log(this.arr);
                        return _this.arr.sort(function (a, b) {
            ...
            var DataSearchCriteria = /** @class */ (function () {
                function DataSearchCriteria() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PostsComponent = /** @class */ (function () {
                ...
                PostsComponent.prototype.getData = function (criteria) {
                    var _this = this;
                    console.log('CRITERIA: ' + criteria.sortColumn + ', ' + criteria.sortDirection);
                    this.PostService.getAllPosts(criteria).subscribe(function (posts) {
                        _this.posts = posts;
                    });
                };
                PostsComponent.prototype.onSorted = function ($event) {
                    console.log('call onSorted($event)!');
                    this.getData($event);
                };
                PostsComponent.prototype.gotoPage = function () {
                    ...
                    if (!re.test(this.gotoPageNum)) {
                        ...
                        var pageNum = Number(this.gotoPageNum);
                        // TODO
                        // maxPage: consider the influence of table filter (ngx-pagination)
                        var maxPage = Math.ceil(this.posts.length / this.numPerPage);
                        if (pageNum > maxPage) {
                ...
                PostsComponent.prototype.objectToCsv = function (data) {
                    var csvRows = [];
                    // get the headers
                ...
                PostsComponent.prototype.getNowDate = function () {
                    var date = new Date();
                ...
                PostsComponent.prototype.Download = function (data) {
                ...
                PostsComponent.prototype.exportCsv = function () {
                    this.Download(this.csvData);
                };
                PostsComponent.prototype.getKeys = function (item) {
                    return Object.keys(item);
                };
                PostsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.countDown = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["timer"])(0, this.tick).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(this.counter), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function () { return --_this.counter; }));
                    this.PostService.getAllPosts({ sortColumn: '#', sortDirection: 'asc' }).subscribe(function (posts) {
                        _this.posts = posts;
                        _this.csvData = _this.objectToCsv(posts);
                    });
                };
